...
public:
	...
	static LPDIRECT3DTEXTURE9	TT_STATIC_CROSS;
	...
	static LPDIRECT3DTEXTURE9	TT_TEXT_GAMEOVER;
	static int					TT_TEXT_GAMEOVER_WIDTH;
	static int					TT_TEXT_GAMEOVER_HEIGHT;

	//Menu
	static LPDIRECT3DTEXTURE9	TT_MENU_BACKGROUND;
	static LPDIRECT3DTEXTURE9	TT_MENU_OPTION;
	static LPDIRECT3DTEXTURE9	TT_MENU_TEXT;

	//Option
	static LPDIRECT3DTEXTURE9	TT_OPTION;
	static LPDIRECT3DTEXTURE9   TT_GAMEOPTION;
	static LPDIRECT3DTEXTURE9	TT_GAMEOPTIONBUTTON;

	//ChangeMap
	static LPDIRECT3DTEXTURE9	TT_GAME_CHANGEMAP;
